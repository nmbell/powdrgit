...
- [Get-GitDiff](help/Get-GitDiff.md)
- [Format-GitDiff](help/Format-GitDiff.md)

For repository management and Powdrgit configuration:
- [New-GitRepo](help/New-GitRepo.md)
- [Invoke-GitClone](help/Invoke-GitClone.md)
- [Find-GitRepo](help/Find-GitRepo.md)
- [Remove-GitRepo](help/Remove-GitRepo.md)
- [Get-GitConfigFile](help/Get-GitConfigFile.md)
- [Add-PowdrgitPath](help/Add-PowdrgitPath.md)
- [Remove-PowdrgitPath](help/Remove-PowdrgitPath.md)
- [Test-PowdrgitPath](help/Test-PowdrgitPath.md)
